...
def parse_arguments():
    ...
    parser.add_argument("--batch-size", "-b", default=64, type=int)  # 512 is OK for resnet18 finetune @ 6Gb of VRAM
...
def main(args):
    ...
    train_dataloader = data.DataLoader(train_dataset, batch_size=args.batch_size, pin_memory=True,
                                       shuffle=True, drop_last=True)
    val_dataset = ThousandLandmarksDataset(os.path.join(args.data, 'train'), train_transforms, split="val")
    val_dataloader = data.DataLoader(val_dataset, batch_size=args.batch_size, pin_memory=True,
